...
Доступны следующие разделы редактора:

- основные параметры: entity, название, иконка и их позиции;
- layout, положение обложки, выравнивание трека и кнопок;
- размеры, opacity и blur;
- переключатели видимости;
- добавление, удаление и редактирование пресетов;
- добавление, удаление и редактирование быстрых команд;
- редактирование цветовой темы и сброс темы к Mint Teal.

После обновления ресурса выполните `Ctrl+F5`. Ресурс должен указывать на свежий `dist/yandex-station-player-card.js` с типом `module`.
