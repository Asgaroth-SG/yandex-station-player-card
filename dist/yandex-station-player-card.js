...
.ysp-volume-vertical { align-self:center; width:32px; height:80px; margin:0; padding:0; border:0; background:linear-gradient(to top, var(--ysp-primary) 0 var(--ysp-volume-pct, 0%), var(--ysp-surface) var(--ysp-volume-pct, 0%) 100%) center / 8px 100% no-repeat; border-radius:999px; cursor:pointer; writing-mode:vertical-lr; -webkit-appearance:none; appearance:none; }
